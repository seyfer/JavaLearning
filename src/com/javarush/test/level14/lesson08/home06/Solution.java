...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        String[] validArray = new String[]{"cartoon", "thriller", "soapOpera"};
        while (true) {

            key = reader.readLine();
            if (!found(validArray, key)) {
                break;
            }
...
8.2 вывести на экран movie.getClass().getSimpleName()
    ...
    private static boolean found(String[] validArray, String key) {
        for (int i = 0; i < validArray.length; i++) {
            if (validArray[i].equals(key)) {
                return true;
            }
        }
